<script lang="ts">
  ...
  const rotateLeft = () => {
    const transitioningImage: HTMLElement = document.getElementById(
      sponsors[sponsors.length - 1].id
    ) as HTMLElement;
...
<div
  class="carousel-container {$config.screenMode} {cssClass}"
